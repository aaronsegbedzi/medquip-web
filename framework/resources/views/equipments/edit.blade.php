				...
				<form class="form" method="post" action="{{ route('equipments.update',$equipment->id) }}">
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input type="text" name="name" class="form-control" value="{{ $equipment->name }}" />
						</div>
						<div class="form-group col-md-6">
							<label for="short_name"> @lang('equicare.short_name_eq')<span class="text-red">&nbsp;*</span></label>
							<input type="text" name="short_name" class="form-control" value="{{ $equipment->short_name }}" />
						</div>
						<div class="form-group col-md-6">
							<label for="company"> @lang('equicare.company')<span class="text-red">&nbsp;*</span></label>
							<input type="text" name="company" class="form-control" value="{{ $equipment->company }}" />
						</div>
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-6">
							...
							<input type="text" name="sr_no" class="form-control" value="{{ old('sr_no')??$equipment->sr_no }}" />
						</div>

						<div class="form-group col-md-6">
							{!! Form::label('hospital_id',__('equicare.hospital')) !!}
							<span class="text-red">&nbsp;*</span>
							{!! Form::select('hospital_id',$hospitals??[],$equipment->hospital_id??null,['placeholder'=>__('equicare.select_option'),'class' => 'form-control select2 hospital']) !!}
						</div>
						<div class="form-group col-md-6">
							{!! Form::label('department',__('equicare.department')) !!}
							<span class="text-red">&nbsp;*</span>
							{!! Form::select('department',$departments??[],$equipment->department??null,['placeholder'=>__('equicare.select_option'),'class' => 'form-control select2 department']) !!}
						</div>
						<div class="form-group col-md-6">
							<label for="date_of_purchase"> @lang('equicare.purchase_date') </label>
							<div class="input-group">

								<input type="text" id="date_of_purchase" name="date_of_purchase" class="form-control" value="{{ $equipment->date_of_purchase }}" />
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								<input type="text" id="order_date" name="order_date" class="form-control" value="{{ $equipment->order_date }}" />
								<span class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</span>
							</div>
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								<input type="text" id="date_of_installation" name="date_of_installation" class="form-control" value="{{ $equipment->date_of_installation }}" />
								<span class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</span>
							</div>
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group">
								...
								<input type="text" id="warranty_due_date" name="warranty_due_date" class="form-control" value="{{ $equipment->warranty_due_date }}" />
								<span class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</span>
							</div>
						...
						<div class="form-group col-md-6">
							...
							<input type="text" name="service_engineer_no" class="form-control" value="{{ $equipment->service_engineer_no }}" />
						</div>
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-6">
							...
							<textarea rows="2" name="notes" class="form-control">{{ $equipment->notes }}</textarea>
						</div>
